    ...
    >
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContent, { backgroundColor: colors.background }]}>
          ...
          {/* Video Player */}
          <View style={[styles.videoContainer, { backgroundColor: colors.darkGray }]}>
            {video.type === 'local' && video.localPath ? (
              ...
              <View style={styles.remoteVideoContainer}>
                ...
                <Text style={[styles.videoTypeText, { color: colors.secondary }]}>ONLINE VIDEO</Text>
                <Text style={[styles.duration, { color: colors.text }]}>{video.duration}</Text>
                <View style={[styles.videoInfo, { backgroundColor: colors.secondary + '20' }]}>
                  <Ionicons name="wifi" size={16} color={colors.secondary} />
                  <Text style={[styles.videoInfoText, { color: colors.secondary }]}>
          ...
          <View style={styles.videoInfoSection}>
            ...
            <View style={styles.videoStats}>
              <View style={styles.stat}>
                ...
                <Text style={[styles.statText, { color: colors.text }]}>{video.duration}</Text>
              </View>
              <View style={styles.stat}>
                <Ionicons 
                  name={video.type === 'local' ? 'phone-portrait' : 'globe-outline'} 
                  size={16} 
                  color={video.type === 'local' ? colors.primary : colors.secondary} 
                />
          ...
          <View style={styles.actionButtons}>
            ...
            {video.type === 'local' && (
              <TouchableOpacity
                style={[styles.downloadButton, { backgroundColor: colors.lightGray }]}
